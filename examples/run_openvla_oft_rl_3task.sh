...
EXPERIMENT_NAME='robotwin_3tasks_image1_wproprio_25chunks_140k_batch32_trail200' 
...
HYDRA_FULL_ERROR=1 python -u -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.actor.traj_mini_batch_size=12 \
