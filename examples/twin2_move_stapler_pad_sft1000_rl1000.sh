...
EXPERIMENT_NAME='twin2_move_stapler_pad_seed1k_sft_40k_batch64_rl_seed1000_seen_max192_chunk25_12' 
...
SFT_MODEL_PATH="/mnt/petrelfs/lihaozhan/Ckpts/Openvla-oft-robotwin2/robotwin2_move_stapler_pad_jiale_seed1k_image1_proprio_aloha_25chunks--40000_chkpt"
...
DATASET_NAME="robotwin2_move_stapler_pad"
...
HYDRA_FULL_ERROR=1 python -u -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.rollout.unnorm_key=robotwin2_move_stapler_pad_1k \
