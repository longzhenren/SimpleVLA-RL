...
EXPERIMENT_NAME='twin2_place_phone_stand_sft1000_20k_batch64_rlseed1000_max200' 
...
SFT_MODEL_PATH="/mnt/petrelfs/lihaozhan/Ckpts/Openvla-oft-robotwin2/robotwin2_place_phone_stand_jiale_seed1k_fix_image1_proprio_aloha_25chunks--20000_chkpt"
...
DATASET_NAME="robotwin2_place_phone_stand"
...
HYDRA_FULL_ERROR=1 python -u -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.rollout.unnorm_key=robotwin2_place_phone_stand_1k \
