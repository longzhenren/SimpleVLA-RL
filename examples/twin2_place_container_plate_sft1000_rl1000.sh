...
EXPERIMENT_NAME='twin2_place_container_plate_seed1k_sft_10k_batch64_rl_seed1000_seen_max150' 
...
SFT_MODEL_PATH="/mnt/petrelfs/lihaozhan/Ckpts/Openvla-oft-robotwin2/robotwin2_place_container_plate_jiale_seed1k_image1_proprio_aloha_25chunks--10000_chkpt"
...
DATASET_NAME="robotwin2_place_container_plate"
...
HYDRA_FULL_ERROR=1 python -u -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.rollout.unnorm_key=robotwin2_place_container_plate_1k \
