...
#/mnt/petrelfs/lihaozhan/Ckpts/twin2-rl-continue/lift_pot_seed1k_sft_20k_batch64_rl_seed1000_max200_step40
PROJECT_NAME='SimpleVLA-RL-robotwin2'
EXPERIMENT_NAME='twin2_lift_pot_seed1k_sft_20k_batch64_rl_seed1000_seen_max200_public' 
...
SFT_MODEL_PATH="/mnt/petrelfs/lihaozhan/Ckpts/Openvla-oft-robotwin2/robotwin2_lift_pot_jiale_seed1k_image1_try2_proprio_aloha_25chunks--20000_chkpt"
CKPT_PATH="/mnt/petrelfs/lihaozhan/Ckpts/oft-robotwin2-rl"
# DATASET_NAME can be libero_10 (libero_Long), libero_90, libero_spatial, libero_object, libero_goal
DATASET_NAME="robotwin2_lift_pot"
VLA_NAME="openvla-oft"
NUM_GPUS=8
# If you want to use 2*8 GPU to RL. Set NUM_NODES=2
NUM_NODES=1 
ALIGN_PATH="/mnt/petrelfs/lihaozhan/Rob/SimpleVLA-RL-robotwin-public/align.json"
...
HYDRA_FULL_ERROR=1 python -u -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.rollout.unnorm_key=robotwin2_lift_pot_1k \
