...
EXPERIMENT_NAME='twin2_handover_mic_7task_try2_sft20k_batch64_seed1000_max200' 
...
SFT_MODEL_PATH="/mnt/petrelfs/lihaozhan/Ckpts/Openvla-oft-robotwin2/robotwin2_7tasks_jiale_image1_fix_seed100_try2_proprio_aloha_25chunks--20000_chkpt"
...
DATASET_NAME="robotwin2_handover_mic"
...
HYDRA_FULL_ERROR=1 python -u -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.rollout.unnorm_key=robotwin2_robotwin2_7tasks \
