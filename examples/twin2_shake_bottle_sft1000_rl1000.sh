...
EXPERIMENT_NAME='twin2_shake_bottle_seed1k_try2_sft_40k_batch64_rl_seed1000_seen_max200' 
...
DATASET_NAME="robotwin2_shake_bottle"
...
HYDRA_FULL_ERROR=1 python -u -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.rollout.unnorm_key=robotwin2_shake_bottle_1k \
