...
EXPERIMENT_NAME='twin2_place_a2b_right_sft1000_40k_batch64_rlseed1000_max200' 
...
SFT_MODEL_PATH="/mnt/petrelfs/lihaozhan/Ckpts/Openvla-oft-robotwin2/robotwin2_place_a2b_right_jiale_seed1k_image1_proprio_aloha_25chunks--40000_chkpt"
...
DATASET_NAME="robotwin2_place_a2b_right"
...
HYDRA_FULL_ERROR=1 python -u -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.rollout.unnorm_key=robotwin2_place_a2b_right_1k \
