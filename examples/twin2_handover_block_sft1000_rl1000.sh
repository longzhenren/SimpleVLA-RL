...
EXPERIMENT_NAME='twin2_handover_block_seed1k_sft_20k_batch64_rl_seed1000_seen_max400_chunk25_12' 
...
SFT_MODEL_PATH="/mnt/petrelfs/lihaozhan/Ckpts/Openvla-oft-robotwin2/robotwin2_handover_block_jiale_seed1k_image1_proprio_try2_aloha_25chunks--20000_chkpt"
...
DATASET_NAME="robotwin2_handover_block"
...
HYDRA_FULL_ERROR=1 python -u -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.rollout.unnorm_key=robotwin2_handover_block_1k \
